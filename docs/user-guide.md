...
Usage of kube-router:
  ...
  -h, --help                             Print usage information.
      ...
      --iptables-sync-timeout duration   The timeout for iptables rule synchronizations (e.g. '5s', '1m'). Must be greater than 0. Will cause unhealthy kube-router health endpoint if missed. (default 30s)
      ...
      --ipvs-sync-timeout duration       The timeout for ipvs config synchronizations (e.g. '5s', '1m', '2h22m'). Must be greater than 0. Will cause unhealthy kube-router health endpoint if missed. (default 30s)
      ...
      --routes-sync-timeout duration     The timeout for route updates and advertisements (e.g. '5s', '1m', '2h22m'). Must be greater than 0. Will cause unhealthy kube-router health endpoint if missed. (default 30s)
